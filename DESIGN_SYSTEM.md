...
This document defines reusable semantic language for Mindgarden's documentation, terminal output, diagrams, reports, sites, and future interactive surfaces. It does not freeze a framework, component library, or final visual identity.
...
The expression should remain organic, contemplative, navigable, and gentle with uncertainty and information density while allowing product-specific identity to vary inside Ego Hygiene's broader family.
